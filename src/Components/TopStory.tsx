      ...
      <div className="container mx-auto">
        ...
        <div className="scroller flex overflow-x-scroll mx-4">
          {topstories.map((article: Articles, i: number) => (
            <div
              key={i}
              className=" min-w-[80vw] h-fit mr-4 mb-12 pb-4 bg-white overflow-hidden shadow-md border border-gray-200 rounded-lg max-w-fit dark:bg-gray-800 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300 ease-in-out"
            >
